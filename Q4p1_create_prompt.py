...
def create_prompt_and_save_by_group(training_summaries_d, training_summaries_s, testing_summaries, group_size_train=3, group_size_test=1,  base_file_path='Q4p1_txt/Q4p1_prompt'):
